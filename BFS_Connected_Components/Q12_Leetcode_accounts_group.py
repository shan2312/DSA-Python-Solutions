...
class Solution:
    ...
    def get_email_group_after_merge(
        self, start_email, email_to_account_ids, queue, visited, accounts
    ):
    ...
    def accountsMerge(self, accounts):
        ...
        for email in email_to_account_ids:
            ...
            email_group_after_merge = self.get_email_group_after_merge(
                email, email_to_account_ids, queue, visited, accounts
            )
